...
const SocialLinks = {
  ...
  Youtube: 'https://www.youtube.com/@advysoralex',
  Discord: '#', // TODO
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-3">
              <a href={SocialLinks.Twitter} className="text-gray-400 hover:text-mint transition-colors">
                <Twitter className="h-4 w-4" />
              </a>
              <a href={SocialLinks.Linkedin} className="text-gray-400 hover:text-mint transition-colors">
                <Linkedin className="h-4 w-4" />
              </a>
              <a href={SocialLinks.Youtube} className="text-gray-400 hover:text-mint transition-colors">
                <Youtube className="h-4 w-4" />
              </a>
              <a href="#" className="text-gray-400 hover:text-mint transition-colors" title="Discord">
              ...
              <a href={SocialLinks.Email} className="text-gray-400 hover:text-mint transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href={SocialLinks.Email} className="text-gray-400 hover:text-mint transition-colors text-sm">
                  Contact
                </a>
              </li>
              <li>
                <a href={SocialLinks.Support} className="text-gray-400 hover:text-mint transition-colors text-sm">
                  Support
                </a>
              </li>
            </ul>
